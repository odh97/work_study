      ...
      >
        ...
        >
          ...
          <input
            type={"text"}
            className={cn(
              "flex w-full items-center rounded-[9999px] border border-grayscale-neutral px-[15px] text-grayscale-dark outline-none hover:border-grayscale-black disabled:border-grayscale-weak disabled:bg-transparent disabled:text-grayscale-neutral",
              height,
              className,
              border,
              fontStyle,
